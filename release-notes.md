...
- **GA release**
    ...
    - Welcome to the General Availability (GA) release of {{site.data.keyword.aios_full_notm}}. This release contains the following features:
        ...
        - __*Data Store*__: Quality monitoring without reliance on Watson Machine Learning, and the ability to use your own custom database, whether or not its on Db2 or IBM Cloud. See [Specify your Custom service](/docs/services/ai-openscale/connect-other.html) for more information.
