...
- __*IBM Cloud Pak for Data V1.2*__: {{site.data.keyword.wos4d_full}} V1.2를 사용하는 경우, [설치 체크리스트](/docs/services/ai-openscale-icp?topic=ai-openscale-icp-inst-install-icp#install)에서 설치 지침을 포함한 문서를 참조하십시오.
