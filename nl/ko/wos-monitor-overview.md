...
1. **인사이트** 탭에서 **배치 추가** 단추를 클릭하십시오.  

   ![배치 선택 페이지](images/config-select-deploy.png)

   사용 가능한 모델 배치 목록이 표시됩니다.
...
![페이로드 로깅 화면이 표시됨](images/payload-logging-gosales001.png)
...
모니터 구성을 계속하려면 **정확성** 탭을 클릭한 후 **시작**을 클릭하십시오. 자세한 정보는 [정확성 또는 품질 모니터 구성](/docs/services/ai-openscale?topic=ai-openscale-acc-monitor)을 참조하십시오. 
