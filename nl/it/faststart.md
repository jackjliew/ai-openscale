...
1.  Accedere all'[account Watson Studio](https://dataplatform.ibm.com/){: external} e iniziare con la creazione di un nuovo progetto. Selezionare **Nuovo progetto**.
...
2. Per questo supporto didattico, fare clic su **No Grazie**, quindi fare clic su **Inizia**.
...
1. Dal [dashboard {{site.data.keyword.aios_short}}](https://aiopenscale.cloud.ibm.com/aiopenscale/){: external}, fare clic sulla scheda **Insight**.

  ![Insight](images/insight-dash-tab.png)

1. Esaminare la pagina Insight per visualizzare una panoramica delle metriche per i modelli distribuiti. È possibile visualizzare gli avvisi per le metriche di correttezza o accuratezza che superano la soglia del 90% .
