...
### Provisioning di un servizio Db2 Warehouse
{: #gs-provdb2}

- [Provisioning di un servizio Db2 Warehouse ![icona link esterno](../../icons/launch-glyph.svg "icona link esterno")](https://{NomeDominio}/catalog/services/db2-warehouse){: nuova_finestra} se non se ne ha ancora uno associato al proprio account:

  ![Db2 Warehouse](images/db2_warehouse.png)

- Fornire un nome al servizio, scegliere il piano iniziale e fare clic sul pulsante **Crea**.
### Caricare i dati di training in Db2 Warehouse
{: #gs-traindb2}
