...
1.  Efetue login em sua [conta do Watson Studio](https://dataplatform.ibm.com/){: external} e inicie criando um novo projeto. Selecione **Novo projeto**.

    ![Criar projeto do Watson Studio](images/studio_create_proj.png)

1.  Selecione o bloco **Padrão**.
...
1.  Na seção **Selecionar tipo de modelo**, selecione **Da amostra** e o modelo `Credit Risk` e, em seguida, clique em **Criar**.
    ...
    ![Formulário de notebook novo](images/credit-sample-model.png)
...
2. Para este tutorial, clique em **Não, obrigado** e, em seguida, clique em **Iniciar**.

1.  Clique no bloco **Aprendizado de máquina do Watson**.
...
1. No [painel do {{site.data.keyword.aios_short}}](https://aiopenscale.cloud.ibm.com/aiopenscale/){: external}, clique na guia **Insights**.

  ![Insights](images/insight-dash-tab.png)

1. Visualize a página Insights para ter uma visão geral das métricas para seus modelos implementados. É possível visualizar alertas para métricas de justiça ou precisão que excedem o limite de 90%.
