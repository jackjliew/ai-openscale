...
# Definindo o esquema de entrada e de saída usando o cliente Python ou a API de REST
{: #schema-def}


{: shortdesc}

O esquema de dados de saída: (do cliente Python)
...
Visualizar a [documentação da API de REST](https://cloud.ibm.com/apidocs/ai-openscale#post-feedback-payload){: external}.
