...
Para cargar un archivo CSV, utilice el botón **Añadir datos de opiniones**.

1. En el panel de control de {{site.data.keyword.aios_short}}, pulse el mosaico de despliegue.
2. En la ventana de despliegue de modelo, pulse el icono **Configuración** ![se muestra el botón de configuración de despliegue](images/configure-deployment-button.png).
3. Pulse el botón **Añadir datos de opiniones**, seleccione el archivo CSV que contiene los datos de opiniones y pulse **Abrir**.
