...
En el caso de problemas binarios, {{site.data.keyword.aios_full}} asigna la categoría de destino al nivel `positivo` o `negativo`. Para ello, la salida de Confusion Matrix sigue el convenio según el cual la etiqueta de la categoría positiva se encuentra en la segunda fila o columna.
