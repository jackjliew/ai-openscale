...
La pestaña **Explicar una transacción** (![pestaña Explicar una transacción](images/insight-transact-tab.png))
le permite buscar un ID de transacción específico para explicar una transacción de despliegue determinada. Para obtener más información, consulte [Supervisión de la explicabilidad](/docs/services/ai-openscale?topic=ai-openscale-ie-ov).

## Herramientas de IA
{: #io-too}

La pestaña **Herramientas de IA** (![pestaña Herramientas de IA](images/aitools.png))
abre un diálogo que proporciona un enlace a las opciones de herramientas de IBM AI adicionales:
...
- *[NeuNetS ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://dataplatform.cloud.ibm.com/ml/neunets){: new_window}* (*Beta*):
Neural Network Synthesizer, "NeuNetS", que está actualmente en el release beta, le permite sintetizar los modelos de IA utilizando
la tecnología de {{site.data.keyword.aios_short}} en Watson Studio. Pulse en el botón "Sintetizar un modelo" para trabajar con NeuNetS.

  ![diálogo NeuNetS](images/neunets-dialog.png)
