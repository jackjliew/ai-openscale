...
1.  A continuación, pulse **Configurar supervisores**.
...
Para obtener más información sobre la interpretación de los resultados, consulte [Obtención de detalles](/docs/services/ai-openscale?topic=ai-openscale-io-ov)
