...
1. [Cree una clave de API de {{site.data.keyword.cloud_notm}} y descárguela](/docs/iam?topic=iam-userapikey#create_user_key){: external}. Necesitará especificar la clave de API en un paso posterior.
...
- Cada despliegue se muestra como un mosaico. Si está siguiendo alguna de las guías de aprendizaje, en el panel de control verá un despliegue `GermanCreditRiskModel`. El ejemplo siguiente muestra un panel de control con muchos modelos desplegados y supervisados:

    ![Panel de control Detalles con muchos despliegues, cada uno de los cuales aparece como un mosaico](images/insight-dashboard.png)
...
2. Deslice el marcador por el gráfico para ver un día y periodo de tiempo que muestren datos y, a continuación, pulse el enlace **Ver detalles**.
   ...
   - Para obtener información sobre cómo interpretar el gráfico de series de tiempo, consulte [Obtención de detalles](/docs/services/ai-openscale?topic=ai-openscale-it-ov).
    ...
    ![Se muestra la pantalla Supervisar datos](images/setup02-0206.png)
...
3. Para ver detalles sobre la supervisión de datos de `EDAD`, asegúrese de que `EDAD` esté seleccionado en el menú desplegable.
  ...
  - Para obtener información sobre cómo interpretar el gráfico de los puntos de datos a una hora específica, consulte [Visualización de datos para una hora específica](/docs/services/ai-openscale?topic=ai-openscale-it-vdet).

    ![Se muestra la pantalla Ver detalles](images/setup03-0206.png)
...
- Para obtener más información sobre cómo interpretar los gráficos y los datos, consulte [Obtención de detalles](/docs/services/ai-openscale?topic=ai-openscale-it-ov).
