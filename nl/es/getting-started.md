...
### Suministro de un servicio de Db2 Warehouse
{: #gs-provdb2}
...
- Proporcione un nombre al servicio, elija un plan Entry y pulse el botón **Crear**.

### Carga de los datos de entrenamiento a Db2 Warehouse
{: #gs-traindb2}
