...
# Eingabe- und Ausgabeschema mithilfe von Python-Client oder REST-API definieren
{: #schema-def}


{: shortdesc}

Ausgabedatenschema: (Python-Client)
...
Lesen Sie die [REST-API-Dokumentation](https://cloud.ibm.com/apidocs/ai-openscale#post-feedback-payload){: external}.
