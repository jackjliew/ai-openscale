...
- __*IBM Cloud Pak for Data V1.2*__: {{site.data.keyword.wos4d_full}} V1.2 を使用している場合は、[インストール・チェックリスト](/docs/services/ai-openscale-icp?topic=ai-openscale-icp-inst-install-icp#install)の文書 (インストール手順を含む) を参照してください。
