...
## 対比的説明では、関連する陽性と関連する陰性が使用される
{: #ie-pp-pn}

対比的説明では、{{site.data.keyword.aios_short}} は、関連する陽性を表す値および関連する陰性を表す値を表示します。 
