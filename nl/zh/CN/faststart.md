...
1.  登录到 [Watson Studio account](https://dataplatform.ibm.com/){: external} 并首先创建新项目。选择**新建项目**。
...
1. 从 [{{site.data.keyword.aios_short}} 仪表板](https://aiopenscale.cloud.ibm.com/aiopenscale/){: external}中，单击**洞察**选项卡。

  ![洞察](images/insight-dash-tab.png)

1. 查看“洞察”页面以查看已部署的模型的度量概述。针对超过 90% 阈值的公平性或准确性度量，您可以查看相应的警报。
