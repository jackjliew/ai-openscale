...
其他教程链接可在[其他资源](/docs/services/ai-openscale?topic=ai-openscale-arsc-ov)主题中找到。
...
- [供应 Db2 Warehouse 服务 ![外部链接图标](../../icons/launch-glyph.svg "External link icon")](https://{DomainName}/catalog/services/db2-warehouse){: new_window} 如果您还没有与您的帐户进行关联：

  ![Db2 Warehouse](images/db2_warehouse.png)

- 为服务提供一个名称，选择 Entry 套餐，然后单击**创建**按钮
