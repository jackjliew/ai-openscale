...
-   在歐盟 (EU) 地區，請參閱[要求在歐盟建立之 {{site.data.keyword.Bluemix}} Watson 資源的支援](/docs/services/watson?topic=watson-gdpr-sar#request-EU){: external}。
-   在歐盟以外地區，請參閱[要求歐盟以外資源的支援](/docs/services/watson?topic=watson-gdpr-sar#request-non-EU){: external}。
...
如需進一步瞭解 IBM 本身的 GDPR 就緒過程、我們的 GDPR 功能以及可支援您邁向合規性過程的供應項目，請參閱[這裡](http://www.ibm.com/gdpr){: external}。
