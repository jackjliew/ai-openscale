...
# Zone sous la courbe ROC ![étiquette bêta](images/beta.png)
{: #quality_roc}

La zone sous la courbe ROC (receiver operating characteristic - fonction d'efficacité du récepteur) donne la surface sous la courbe de rappel et de taux de faux positifs.
Elle correspond à la sensibilité par rapport au taux de conséquences.
{: shortdesc}

## Zone sous la courbe ROC en bref
{: #quality_roc-glance}
...
La zone sous la courbe ROC est tracée paramétriquement
