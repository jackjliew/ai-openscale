...
- Select the [**Manage**](https://console.bluemix.net/registration?target=%2Fdeveloper%2Fwatson%2Flaunch-tool%2Faiopenscale?hideTours=true) tab, and click the **Launch application** button. Click **Begin**.
